...
from utils.checks import has_any_role, collect_roles, bot_missing_permissions, is_dangerous_role, setup_permission_check
...
class RoleAssignSystem(commands.Cog):
    ...
    @commands.check(setup_permission_check("role_assign"))
    @commands.guild_only()
