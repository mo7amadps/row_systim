...
COMMAND_GROUPS = [
    ...
    ("🛡️ الإدارة", [
        ...
        ("ق [#قناة]", "قفل القناة"),
        ("مسح عدد", "مسح رسائل"),
        ("مسح @شخص عدد", "مسح رسائل شخص محدد (آخر يوم بس)"),
    ...
    ("⚙️ الإعداد (أدمن بس)", [
        ...
        ("/set-up-clear-v2", "إعداد مسح شخص محدد"),
        ("/mo7-log", "تحديد كل قنوات اللوق بمكان واحد"),
...
class HelpSystem(commands.Cog):
    ...
    async def help_cmd(self, interaction: discord.Interaction):
        ...
        # قائمة ديناميكية من الأوامر المسجلة فعلياً، حتى لا يبقى /help ناقصاً
        # عندما نضيف أمراً جديداً في أحد الـCogs.
        embeds.extend(
            command_embeds(
                self.bot,
                "📚 كل الأوامر المسجلة في البوت",
