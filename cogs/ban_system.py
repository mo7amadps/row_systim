...
from utils.checks import can_target, has_role, has_any_role, collect_roles, bot_missing_permissions
...
class BanFlow:
    ...
    async def execute(self, interaction: discord.Interaction):
        ...
        is_allowed = has_any_role(fresh_invoker, b["allowed_role_ids"])
        if not (is_unlimited or is_allowed):
            # ما عاد معه صلاحية - ما منرد عليه بأي رسالة، بس منسكت (نفس مبدأ باقي الأوامر)
