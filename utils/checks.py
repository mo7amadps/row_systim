...
def setup_permission_check(section: str, extra_role_key: str = None, role_key: str = "allowed_role_ids"):
    """
    ...
    role_key: اسم الحقل يلي فيه لستة الرتب المسموحة جوا هاد الـ section
    (افتراضياً "allowed_role_ids" - بس بعض الأنظمة متل السجن عندها اسم مختلف
    لكل أمر، متل "imprison_role_ids" و"release_role_ids").
    """
    async def predicate(ctx: commands.Context) -> bool:
        ...
        allowed_role_ids = config.get(role_key, [])
