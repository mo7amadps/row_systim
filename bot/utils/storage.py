    ...
    async def get_guild(guild_id: int) -> dict:
        async with _lock:
            with sqlite3.connect(DB_PATH) as conn:
                ...
                default_data = {
                    "ban": {"allowed_role_ids": [], "daily_limit": 0, "unlimited_role_id": None, "log_channel_id": None},
                    "warn": {"allowed_role_ids": [], "log_channel_id": None},
                    "unwarn": {"allowed_role_ids": [], "log_channel_id": None},
                    "nickname": {"allowed_role_ids": [], "log_channel_id": None},
                    "rar": {"allowed_role_ids": [], "log_channel_id": None},
                    "prison": {"allowed_role_ids": [], "jail_role_id": None, "prison_channel_id": None, "log_channel_id": None}
                }
